...
def index():
    ...
    if 'username' in session:
        ...
        return render_template("index.html",username=username, produtos=produtos, enderecos=enderecos)
...
def meus_enderecos():
    ...
    if 'username' in session:
        ...
        with mysql.cursor() as cur:
            ...
            return render_template('/carrinho.html', enderecos=enderecos, username=username)
